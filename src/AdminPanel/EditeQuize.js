...
const EditeQuize = () => {
    ...
    return (
        ...
        <h2 className="text-center md:text-3xl lg:text-3xl sm:text-2xl mb-4 font-bold"> Update Quize </h2>
        <form onSubmit={handleSubmit(handleAddQuize)} className="form_inside">
            ...
            <div className="insert_Options grid sm:grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-2 ">
                ...
                <input type="text"  defaultValue={quizeOptions[0]}  {...register("optionOne", {
                required: "Name is Required",
              })} placeholder="option 1" />
                </div>
                <div className="single_option">
                <input type="text"  defaultValue={quizeOptions[1]}  {...register("optionTow", {
                required: "Name is Required",
              })} placeholder="option 2" />
                </div>
                <div className="single_option">
                <input type="text"  defaultValue={quizeOptions[2]}  {...register("optionThree", {
                required: "Name is Required",
              })} placeholder="option 3" />
                </div>
                <div className="single_option">
                <input type="text"  defaultValue={quizeOptions[3]}  {...register("optionFour", {
                required: "Name is Required",
            ...
            <div className="single_option">
           <input defaultValue={correctAnswer} type="text"   {...register("correctAnswer", {
                required: "Name is Required",
            ...
            <div className="select_categorys">
               ...
               <select placeholder="chose category" defaultValue={categoryName} name="select categorys"  {...register("categoryName", {
                required: "Name is Required",
              })} id="">
