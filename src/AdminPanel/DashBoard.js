...
const DashBoard = () => {
    return (
        <div>
            <div className='flex items-center mb-5'> <span className='text-5xl text-success mr-3'> <MdAdminPanelSettings/> </span> <h2 className='text-success text-2xl'> Admin Pannel </h2> </div>
           ...
           <div className="divfour p-3">
            ...
            <div className="divtwo p-3">
           <div className='flex justify-center'> <span className='text-5xl text-white'> <GiBrain/> </span></div>
            <div className='text-center text-white'>
